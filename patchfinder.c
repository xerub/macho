...
static int insn_is_add_reg_imm(uint16_t * i)
{
    if ((*i & 0xFFF0) == 0xF100)
        return 1;
    else if ((*i & 0xF800) == 0x3000)
        return 1;
    else
        return 0;
}

static int insn_add_reg_imm_rd(uint16_t * i)
{
    if ((*i & 0xFFF0) == 0xF100)
        return (*(i + 1) >> 8) & 0xF;
    else if ((*i & 0xF800) == 0x3000)
...
static int insn_add_reg_imm_rn(uint16_t * i)
{
    if ((*i & 0xFFF0) == 0xF100)
        return (*i & 0xF);
    else if ((*i & 0xF800) == 0x3000)
...
static int insn_add_reg_imm_imm(uint16_t * i)
{
    if ((*i & 0xFFF0) == 0xF100)
        return *(i + 1) & 0xFF;
    else if ((*i & 0xF800) == 0x3000)
